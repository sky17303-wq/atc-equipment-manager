...
컴퓨팅교사협회 교구 대여 운영을 위한 로컬 MVP 초안입니다. 현재 버전은 다음을 포함합니다.
...
- 신청 제출, 승인, 반출, 반납, 검수 상태 흐름
- 모의 ERP 권한, 회원/기관 관리, 관리자 교구 CRUD, CSV 반영, 통계, QR 라벨 초안
- ERP/Supabase 로그인 세션을 이용한 교구 회원 자동 연결 골격
